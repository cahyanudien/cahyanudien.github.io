...
document.querySelector("#app").innerHTML = `
  <div class="container">
    ...
    <div class="top-bar">
      ...
      <div class="lang-switch">
        ...
        <a href="/hening-yang-berjalan/">ID</a>
      </div>
    </div>
    ...
    <div class="hero">
      ...
      <div class="cover-block-en" title="book cover"></div>
  ...
  bookData.authorBio.githubHandle
    ...
    <div class="intro-card">
      <p>${bookData.intro}</p>
      <div class="attribution">— about</div>
    </div>
    ...
    <!-- where to buy -->
    <div class="section-title" id="purchase-books">Where to read</div>
    ...
    <div class="toc-full">
      ...
      <div style="color: #6b6b6b; font-size: 0.9rem; margin-bottom: 1rem">
        ${bookData.poemCount} poems · three parts
      </div>
      ...
      <div class="toc-footer">
        <span>Heart Words · Closing · About the Author</span>
      </div>
    </div>
    ...
    <div class="action-row" id="action-row">
      ...
      <a href="https://www.goodreads.com/book/show/249471367-stillness-that-walks" target="_blank" class="btn-secondary"> ⭐ Goodreads </a>
    </div>

    <!-- footer -->
    <div class="footer">
      © 2026 ${bookData.author} · Hening yang Berjalan ·
