  ...
  <div class="container">
    ...
    <div class="top-bar">
      ...
      <div class="lang-switch">
        <a href="../stillness-that-walks/">EN</a>
    ...
    <div class="hero">
      ...
      <div class="cover-block-id" title="sampul buku"></div>
  ...
  bookData.authorBio.githubHandle
    ...
    <div class="toc-full">
      ...
      <div style="color: #6b6b6b; font-size: 0.9rem; margin-bottom: 1rem">
        ${bookData.poemCount} puisi · tiga bagian
      </div>
      ...
      <div class="toc-footer">
        <span>Kata Hati · Penutup · Tentang Penulis</span>
      </div>
    </div>
    ...
    <div class="action-row" id="action-row">
      ...
      <a href="https://www.goodreads.com/book/show/251506987-hening-yang-berjalan" target="_blank" class="btn-secondary"> ⭐ Goodreads </a>
    </div>
